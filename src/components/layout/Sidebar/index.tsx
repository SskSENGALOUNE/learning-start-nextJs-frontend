...
const navItems = [
  ...
  { href: "/customer", label: "Customers", icon: icons.customers },
  {
    href: "/bank-accounts/compare",
    label: "Bank Accounts (Offset vs Cursor)",
    icon: icons.bank,
  },
  {
    href: "/bank-accounts/benchmark",
    label: "Benchmark (Compare 4 method)",
    icon: icons.benchmark,
  },
  {
    href: "/bank-accounts/composite",
    label: "Composite Filter",
    icon: icons.filter,
  },
  { href: "/ui-component", label: "UI Component", icon: icons.uiComponent },
];
